...
template<> DAY_AT_GUARDHOUSE_API UScriptStruct* StaticStruct<FNPCData>()
{
	...
	struct Z_CompiledInDeferFile_FID_Users_TOP_Documents_GitHub_GateKeepers_Dilemma_Source_Day_At_Guardhouse_DialogueWidget_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_TOP_Documents_GitHub_GateKeepers_Dilemma_Source_Day_At_Guardhouse_DialogueWidget_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_TOP_Documents_GitHub_GateKeepers_Dilemma_Source_Day_At_Guardhouse_DialogueWidget_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_TOP_Documents_GitHub_GateKeepers_Dilemma_Source_Day_At_Guardhouse_DialogueWidget_h_1295391421(TEXT("/Script/Day_At_Guardhouse"),
		Z_CompiledInDeferFile_FID_Users_TOP_Documents_GitHub_GateKeepers_Dilemma_Source_Day_At_Guardhouse_DialogueWidget_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_TOP_Documents_GitHub_GateKeepers_Dilemma_Source_Day_At_Guardhouse_DialogueWidget_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Users_TOP_Documents_GitHub_GateKeepers_Dilemma_Source_Day_At_Guardhouse_DialogueWidget_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_TOP_Documents_GitHub_GateKeepers_Dilemma_Source_Day_At_Guardhouse_DialogueWidget_h_Statics::ScriptStructInfo),
		nullptr, 0);
